...
class MemberControllerTest {
    ...
    void signUp() throws Exception{
        ...
        String json = objectMapper.writeValueAsString(memberRequestDto);
        MockMultipartFile file = new MockMultipartFile("file", "file", "image/*", json.getBytes(StandardCharsets.UTF_8));
        MockMultipartFile memberRequest = new MockMultipartFile("memberRequest", "memberRequest", "application/json", json.getBytes(StandardCharsets.UTF_8));

        given(memberService.signUp(memberRequestDto, file)).willReturn(new CommonResponseDto("OK"));
    ...
    void deleteMember() throws Exception{
        // given
        when(memberService.deleteMember(1L)).thenReturn(new CommonResponseDto("OK"));
